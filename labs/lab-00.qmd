...
- Copy the entire string of characters (not including the quotation marks) and paste them into [the settings page on GitHub](https://github.coecis.cornell.edu/settings/ssh/new). Give the key an informative title such as "INFO 3312 RStudio Workbench". Click "Add SSH key."
...
-   Go to the course organization at [https://github.coecis.cornell.edu/info3312-s23](https://github.coecis.cornell.edu/info3312-s23) organization on GitHub.
    Click on the repo with the prefix **lab-00**.
