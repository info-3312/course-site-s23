...
countdown_fullscreen(minutes = 3, font_size = "20vw")
```
...
- GitHub organization: [github.coecis.cornell.edu/info2950-s23](https://github.coecis.cornell.edu/info3312-s23)
...
- AI code helpers are prohibited.
